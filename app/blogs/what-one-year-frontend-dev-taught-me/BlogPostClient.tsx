    ...
    >
      <div className="w-full flex flex-col items-center justify-center px-6 py-4 max-w-3xl mx-auto ">
        ...
        <h2 className="mr-auto mt-1 text-neutral-400 font-normal text-base">
          By Ayantik Sarkar &bull; 12.06.2026 &bull; <a href="https://medium.com/@ayantik.sarkar2020/what-1-year-of-frontend-development-taught-me-about-building-memorable-websites-fc8a9497987c?postPublishedType=initial" target="_blank" rel="noopener noreferrer">Medium</a>
        </h2>
        ...
        <div className="rounded-lg h-full w-full p-3 mt-6">
          <Image
            ...
            height={1024}
            width={1536}
            alt="Comparison of a memorable, modern web interface versus a forgettable, generic one"
        ...
        <div className="rounded-lg h-full w-full p-3">
          <Image
            ...
            height={1024}
            width={1536}
            alt="Example of a well-designed, modern user interface with clear visual hierarchy"
            className="w-full rounded-lg"
          />
        </div>
        ...
        >
          <Image
            ...
            height={910}
            width={1918}
            alt="Chánh Đại's personal portfolio website homepage"
            className="w-full rounded-lg"
          />
        ...
        >
          <Image
            ...
            height={902}
            width={1882}
            alt="Ayantik Sarkar's personal portfolio website homepage"
            className="w-full rounded-lg"
          />
          <p className="text-xs p-3 dark:text-neutral-300 text-neutral-700">
        ...
        <p className="p-3 dark:text-neutral-300 text-neutral-700">
          ...
          <br />
          <br />
          <a href="https://ramx.in/" className="font-semibold" target="_blank" rel="noopener noreferrer">
