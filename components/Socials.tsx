    ...
    >
      <div className="flex gap-2">
        <Link
          ...
          target="_blank"
          className="flex-1 dark:hover:bg-neutral-950 duration-300 border border-neutral-300 dark:border-neutral-800 h-18 dark:bg-black rounded-lg flex items-center justify-between p-3 pl-5"
        >
